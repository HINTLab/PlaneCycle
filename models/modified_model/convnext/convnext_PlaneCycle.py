...
class ConvNeXt(nn.Module):
    ...
    def convert_to_PlaneCycle(self, cycle_order= ("HW", "DW", "DH", "HW"), pool_method=""):
        # need to call this function after loading weight
    ...
    def forward(self, x, **kwargs):
        ...
        for i in range(4):
            ...
            x = self.downsample_layers[i](x)  # → (B*D, C, H, W)
